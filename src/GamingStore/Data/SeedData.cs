...
namespace GamingStore.Data
{
    public class SeedData
    {
        ...
        private static void SeedOrdersAndPayments(StoreContext context, Item[] items, List<Store> stores)
        {
        ...
        private static List<Store> SeedStores(StoreContext context, string directoryPath, Item[] items)
        {
        ...
        private static Item[] SeedItems(StoreContext context)
        {
